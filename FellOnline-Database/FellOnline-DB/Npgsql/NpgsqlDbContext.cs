...
namespace FellOnline.Database.Npgsql
{
    public class NpgsqlDbContext : DbContext
    {
        ...
        public DbSet<CharacterAppearanceEntity> CharacterAppearance { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CharacterAppearanceEntity>()
            .HasIndex(ca => ca.CharacterID)
            .IsUnique();
            /*
            // other settings
