...
{
	public abstract class FSerializableDictionaryBase
	{
	...
	[Serializable]
	public abstract class SerializableDictionaryBase<TKey, TValue, TValueStorage> : FSerializableDictionaryBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, System.Runtime.Serialization.ISerializable
	{
	...
	{
		public class Storage<T> : FSerializableDictionaryBase.Storage
		{
			public T data;
		}
	}
