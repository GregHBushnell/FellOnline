...
{
	[CustomPropertyDrawer(typeof(FSerializableDictionaryBase), true)]
	[CustomPropertyDrawer(typeof(FSerializableHashSetBase), true)]
	public class FSerializableDictionaryPropertyDrawer : PropertyDrawer
	{
		...
		static FSerializableDictionaryPropertyDrawer()
		{
	...
	[CustomPropertyDrawer(typeof(FSerializableDictionaryBase.Storage), true)]
