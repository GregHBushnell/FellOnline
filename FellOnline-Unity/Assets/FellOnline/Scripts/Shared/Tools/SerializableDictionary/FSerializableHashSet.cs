...
{
	public abstract class FSerializableHashSetBase
	{
	...
	[Serializable]
	public abstract class SerializableHashSet<T> : FSerializableHashSetBase, ISet<T>, ISerializationCallbackReceiver, IDeserializationCallback, System.Runtime.Serialization.ISerializable
	{
		HashSet<T> m_hashSet;
		[SerializeField]
		T[] m_keys;
