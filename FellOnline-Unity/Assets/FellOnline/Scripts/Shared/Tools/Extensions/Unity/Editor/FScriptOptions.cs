...
{
    [InitializeOnLoad]
    public class FScriptOptions
    {
        static FScriptOptions()
        {
		...
		[MenuItem("FellOnline/Script Compilation/Recompile And Continue Playing")]
        ...
        [MenuItem("FellOnline/Script Compilation/Recompile After Finished Playing")]
        ...
        [MenuItem("FellOnline/Script Compilation/Stop Playing And Recompile")]
        ...
        [MenuItem("FellOnline/Script Compilation/Recompile And Continue Playing", true)]
        static bool ScriptCompilationValidation()
        {
            //Here, we uncheck all options before we show them
            Menu.SetChecked("FellOnline/Script Compilation/Recompile And Continue Playing", false);
            Menu.SetChecked("FellOnline/Script Compilation/Recompile After Finished Playing", false);
            Menu.SetChecked("FellOnline/Script Compilation/Stop Playing And Recompile", false);
            ...
            {
                case 0:
                    Menu.SetChecked("FellOnline/Script Compilation/Recompile And Continue Playing", true);
                    break;
                case 1:
                    Menu.SetChecked("FellOnline/Script Compilation/Recompile After Finished Playing", true);
                    break;
                case 2:
                    Menu.SetChecked("FellOnline/Script Compilation/Stop Playing And Recompile", true);
                    break;
            }
            return true;
        }
        ...
        [MenuItem("FellOnline/Script Compilation/Auto Refresh")]
        ...
        [MenuItem("FellOnline/Script Compilation/Auto Refresh", true)]
        static bool AutoRefreshToggleValidation()
        {
            var status = EditorPrefs.GetInt("kAutoRefresh");
            if (status == 1)
                Menu.SetChecked("FellOnline/Script Compilation/Auto Refresh", true);
            else
                Menu.SetChecked("FellOnline/Script Compilation/Auto Refresh", false);
            return true;
        }
    }
}