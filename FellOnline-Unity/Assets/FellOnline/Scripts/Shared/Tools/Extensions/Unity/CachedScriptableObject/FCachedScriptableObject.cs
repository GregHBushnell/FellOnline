...
{
	public abstract class FCachedScriptableObject<T> : ScriptableObject where T : FCachedScriptableObject<T>, FICachedObject
	{
		...
		/// </summary>
		public static List<FICachedObject> Get<U>(HashSet<int> ids) where U : T
		{
			List<FICachedObject> objects = new List<FICachedObject>();
