...
namespace FellOnline.Shared
{
	...
	{
		[MenuItem("FellOnline/QuickStart/Client Bootstrap", priority = -10)]
		...
		[MenuItem("FellOnline/QuickStart/Login Bootstrap", priority = -9)]
		...
		[MenuItem("FellOnline/QuickStart/World Bootstrap", priority = -8)]
		...
		[MenuItem("FellOnline/QuickStart/Scene Bootstrap", priority = -7)]
