...
namespace FellOnline.Shared
{
	...
	public class FInventoryController : FItemContainer
	{
			...
			switch (msg.fromInventory)
			{
				...
				case InventoryType.Bank:
					if (Character.BankController != null &&
						Character.BankController.TryGetItem(msg.from, out FItem bankItem))
					{
						if (TryGetItem(msg.to, out FItem inventoryItem))
						{
