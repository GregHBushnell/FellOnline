...
{
	public class FItemStackable : FIStackable<FItem>
	{
		private FItem item;
		public uint Amount;
		...
		public void Initialize(FItem item, uint amount)
		{
			this.item = item;
			Amount = amount;
		}
		...
		/// </summary>
		public bool CanAddToStack(FItem other)
		{
		...
		/// </summary>
		public bool AddToStack(FItem other)
		{
			if (other == null) return false;
		...
		/// </summary>
		public bool TryUnstack(uint amount, out FItem instance)
		{
			if (amount < 1)
			{
				instance = null;
