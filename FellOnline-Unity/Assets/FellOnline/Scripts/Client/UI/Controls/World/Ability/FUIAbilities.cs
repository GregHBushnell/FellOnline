...
{
	public class FUIAbilities : FUICharacterControl
	{
		...
		public void AddAbility(long id, FAbility ability)
		{
			if (ability == null)
			{
				return;
			...
			InstantiateButton(id, ability.Template.Icon, FReferenceButtonType.Ability, AbilityTabType.Ability, ability.Tooltip(), ref Abilities);
		}

		public void AddKnownAbility(long id, FBaseAbilityTemplate template)
		{
			FAbilityEvent abilityEvent = template as FAbilityEvent;
			if (abilityEvent != null)
			{
				InstantiateButton(id, template.Icon, FReferenceButtonType.None, AbilityTabType.KnownAbilityEvent, template.Tooltip(), ref KnownAbilityEvents);
			}
			else
			{
				FAbilityTemplate abilityTemplate = template as FAbilityTemplate;
				if (abilityTemplate != null)
				{
					InstantiateButton(id, template.Icon, FReferenceButtonType.None, AbilityTabType.KnownAbility, template.Tooltip(), ref KnownAbilities);
				}
			}
		}

		private void InstantiateButton(long id, Sprite icon, FReferenceButtonType buttonType, AbilityTabType tabType, string toolTip, ref List<UIAbilityButton> container)
		{
