...
{
	public class FUITooltipButton : Button
	{
		private Sprite cachedSprite;
		private string cachedLabel;
		private FUITooltip currentUITooltip;
		...
		public FITooltip Tooltip { get; private set; }
		...
		public void Initialize(int index, Action<int, object[]> onLeftClick, Action<int, object[]> onRightClick, FITooltip tooltip = null, string extraTooltipInfo = "", Action<int, object[]> onCtrlClick = null, object[] optionalParams = null)
		{
			Index = index;
			OnLeftClick = null;
		...
		public void Initialize(Character character, FITooltip tooltip)
		{
			Character = character;
			Tooltip = tooltip;
			if (Icon != null)
