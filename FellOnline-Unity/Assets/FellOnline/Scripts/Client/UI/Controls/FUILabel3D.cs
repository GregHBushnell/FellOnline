...
{
	public class FUILabel3D : FUIObject3D
	{
		public string Text = "";
		...
		public static FUILabel3D Create(string text, int fontSize, Transform transform)
		{
			return Create(text, "", fontSize, Color.white, false, transform, Vector2.zero);
		}
		public static FUILabel3D Create(string text, int fontSize, Transform transform, Vector2 pixelOffset)
		{
			return Create(text, "", fontSize, Color.white, false, transform, pixelOffset);
		}
		public static FUILabel3D Create(string text, int fontSize, Color color, Transform transform)
		{
			return Create(text, "", fontSize, color, false, transform, Vector2.zero);
		}
		public static FUILabel3D Create(string text, int fontSize, Color color, Transform transform, Vector2 pixelOffset)
		{
			return Create(text, "", fontSize, color, false, transform, pixelOffset);
		}
		public static FUILabel3D Create(string text, int fontSize, Color color, bool isFade, Transform transform)
		{
			return Create(text, "", fontSize, color, isFade, transform, Vector2.zero);
		}
		public static FUILabel3D Create(string text, int fontSize, Color color, bool isFade, Transform transform, Vector2 pixelOffset)
		{
			return Create(text, "", fontSize, color, isFade, transform, pixelOffset);
		}
		public static FUILabel3D Create(string text, string extraText, int fontSize, Color color, bool isFade, Transform transform, Vector2 pixelOffset)
		{
			...
			FUILabel3D label = (FUILabel3D)newObject.AddComponent<FUILabel3D>();
