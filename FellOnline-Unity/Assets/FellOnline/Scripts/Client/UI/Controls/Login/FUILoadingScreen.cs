...
{
	public class FUILoadingScreen : FUIControl
	{
		[Header("Loading Screen Parameters")]
		public Slider LoadingProgress;
		public Image LoadingImage;
		public FWorldSceneDetailsCache Details;
	...
	public void OnClientSceneWorldReconnectBroadcastReceived(SceneWorldReconnectBroadcast reconnect, Channel channel)
		{
			if (!string.IsNullOrWhiteSpace(reconnect.sceneName) &&
				...
				Details.Scenes.TryGetValue(reconnect.sceneName, out FWorldSceneDetails details) &&
				details.Teleporters.TryGetValue(reconnect.teleporterName, out FSceneTeleporterDetails teleporter))
			{
